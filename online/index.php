            ...
            <div id="main" class="col-md-12">
                ...
                <div id="store">
                    ...
                    <div class="row">
                        ...
                        // Query dasar untuk mendapatkan produk
                        ...
                        // Membatasi query berdasarkan pagination
                        $query .= "LIMIT $mulai, $halaman";
                        $result = mysqli_query($koneksi, $query);
                        $total = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM produk, kategori WHERE kategori_id=produk_kategori"));
